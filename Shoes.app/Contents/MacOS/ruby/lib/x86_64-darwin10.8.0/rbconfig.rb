...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/x86_64-darwin10.8.0")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/jeremywoertink/.rvm/rubies/ruby-1.9.2-p290")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/jeremywoertink/.rvm/rubies/ruby-1.9.2-p290' '--enable-shared' '--disable-install-doc' '--with-libyaml-dir=/Users/jeremywoertink/.rvm/usr' 'CC=/usr/bin/gcc-4.2'"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "x86_64-darwin10.8.0"
  ...
  CONFIG["target_os"] = "darwin10.8.0"
  CONFIG["target_vendor"] = "apple"
  CONFIG["target_cpu"] = "x86_64"
  CONFIG["target"] = "x86_64-apple-darwin10.8.0"
